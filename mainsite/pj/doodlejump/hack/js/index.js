...
var platforms = [],
	...
	flag = 0,
	menuloop, broken = 0,
	dir, score = 999999999999999  , firstRun = false;
...
function Platform() {
	...
	else if (score >= 2000 && score < 5000) this.types = [4];
	else if (score >= 1000 && score < 2000) this.types = [4];
	else if (score >= 500 && score < 1000) this.types = [3];
	else if (score >= 100 && score < 500) this.types = [4];
	else this.types = [1];
